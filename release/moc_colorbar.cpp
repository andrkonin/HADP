...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_COLORBAR_t, stringdata) + ofs \
...
const QMetaObject COLORBAR::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_COLORBAR.data,
      qt_meta_data_COLORBAR,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_COLORBAR.stringdata))
